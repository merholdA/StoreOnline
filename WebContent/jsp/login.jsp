				...
				<div
					...
					<form class="form-horizontal" action="${pageContext.request.contextPath}/UserServlet?method=userLogin" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<c:if test="${ empty usernameLG }">
								<input type="text" class="form-control" id="username" name="username" placeholder="请输入用户名">
								</c:if>
								<c:if test="${ not empty usernameLG }">
								<input type="text" class="form-control" id="username" name="username" value="${ usernameLG }">
								</c:if>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								<div class="checkbox">
									...
									<label> <input type="checkbox" name="recordUsername" value="recordUsername"
									<c:if test="${ not empty usernameLG }">checked</c:if>> 记住用户名</label>
								</div>
							</div>
						</div>
						<div class="form-group">
