		...
		<div class="container">
			<div class="row">
				<div style="border: 1px solid #e4e4e4;width:930px;margin-bottom:10px;margin:0 auto;padding:10px;margin-bottom:10px;">
					...
					<a href="${pageContext.request.contextPath}/">${category.cname}&nbsp;&nbsp;&gt;</a>
					<a>${product.pname}</a>
				</div>
				...
				<div style="margin:0 auto;width:950px;">
					...
					<div class="col-md-6">
						...
						<div style="padding:10px;border:1px solid #e7dbb1;width:330px;margin:15px 0 10px 0;;background-color: #fffee6;">
							...
							<form id="add_cart_form" action="${pageContext.request.contextPath}/CartServlet?method=addToCart" method="post">
								...
								<a href="javascript:void(0)">
									<input style="background: url('${pageContext.request.contextPath}/img/product.gif') no-repeat scroll 0 -600px rgba(0, 0, 0, 0);height:36px;width:127px;"
										id="add_cart_btn" value="加入购物车" type="button">
								</a> &nbsp;收藏商品</div>
							</form>
						</div>
					</div>
