...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">
			function addProduct(){
				window.location.href = "${pageContext.request.contextPath}/AdminServlet?method=intoAddProductUI";
			}
		</script>
	</HEAD>
	<body>
					...
					<tr>
						<td class="ta_01" align="center" bgColor="#f5fafe">
							<table cellspacing="0" cellpadding="1" rules="all"
								...
								<c:forEach items="${page.productList}" var="product" varStatus="status">
		...
		<div style="width:380px;margin:0 auto;margin-top:50px;">
			<ul class="pagination" style="text-align:center; margin-top:10px;">
				...
				<c:forEach begin="1" end="${page.pageCount}" var="pageNum">
					<li><a href="${pageContext.request.contextPath}/AdminServlet?method=getProductsByPaging&pageIndex=${pageNum}">${pageNum}</a></li>
				</c:forEach>
				<!-- 
